      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400">
            {isLogin ? "Sign in to your teacher account" : "Join as a teacher"}
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {!isLogin && (
            <div className="relative">
              ...
              <input
                ...
                required={!isLogin}
                className="w-full bg-gray-800/50 border border-gray-700 rounded-lg pl-12 pr-4 py-3 text-white placeholder-gray-400 focus:outline-none focus:border-orange-500 transition-colors"
              />
            </div>
          )}
          ...
          <motion.button
            ...
            className="w-full bg-orange-500 hover:bg-orange-600 disabled:bg-orange-500/50 text-white font-semibold py-3 rounded-lg transition-colors flex items-center justify-center space-x-2"
          >
            {loading ? (
